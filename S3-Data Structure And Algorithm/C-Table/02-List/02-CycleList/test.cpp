...
using namespace std;
char menu();
void Add(CList<string,double> & dl);
void Delete(CList<string,double> & dl);
void Search(CList<string,double> & dl);
void Change(CList<string,double> & dl);
void Print(CList<string,double> & dl);
int main()
{	char ch;
	CList<string,double> dl;
	while((ch=menu())!='q')
		switch(ch)
		{	case 'a':Add(dl);
				break;
